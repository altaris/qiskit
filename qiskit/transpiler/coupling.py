...
class CouplingMap:
    ...
    @classmethod
    def from_heavy_hex(cls, distance, bidirectional: bool = True) -> "CouplingMap":
    ...
    @classmethod
    def from_heavy_square(cls, distance, bidirectional: bool = True) -> "CouplingMap":
    ...
    @classmethod
    def from_hexagonal_lattice(cls, rows, cols, bidirectional: bool = True) -> "CouplingMap":
